...
class ConfigManager:
    ...
    def __init__(self, app_name: str = "db_connector", config_file: str = "connections.toml"):
        """
        初始化配置管理器
    ...
    def _save_config(self, config: dict):
        ...
        try:
            # 更新最后修改时间
            config['metadata']['last_modified'] = '2024-01-01T00:00:00Z'  # 应该使用当前时间
        ...
        try:
            ...
            for field in sensitive_fields:
                if field in encrypted_config:
                    encrypted_config[field] = self.crypto.encrypt(encrypted_config[field])
        ...
        try:
            ...
            for field in sensitive_fields:
                if field in connection_config:
                    connection_config[field] = self.crypto.decrypt(connection_config[field])
