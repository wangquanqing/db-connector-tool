...
class ConfigValidator:
    ...
    def validate_config(config: Dict[str, Any]) -> None:
        ...
        # 验证connections字段类型
        GenericValidator.validate_field_type(config["connections"], dict, "connections字段")
        ...
        GenericValidator.validate_required_fields(metadata, required_metadata_fields, "metadata")
...
class ConnectionValidator:
    ...
    def validate_basic_config(config: Dict[str, Any]) -> None:
        ...
        if db_type not in ConnectionValidator.SUPPORTED_DATABASE_TYPES:
            supported_types = ", ".join(sorted(ConnectionValidator.SUPPORTED_DATABASE_TYPES))
            raise ConfigError(
