...
class DBConnectorError(Exception):
    ...
    def __str__(self) -> str:
        ...
        返回格式化的异常信息字符串，包含异常类型、错误信息和错误代码。
...
class QueryError(DatabaseError):
    ...
    def _get_query_preview(self, query: str, max_length: int = 100) -> str:
        ...
        避免在日志中泄露完整的SQL语句，同时保留足够的上下文信息用于调试。
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            error_code: 错误代码
            details: 详细的错误信息
            **kwargs: 其他验证相关信息，如 field_name, expected_type, validation_rules

        Notes:
            实际值可能包含敏感信息，需谨慎处理，不自动填充 actual_value。
